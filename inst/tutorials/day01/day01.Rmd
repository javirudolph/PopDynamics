...
Now, we can calculate our population size at each of the time points.
...
```{r, expgrowth03, exercise=TRUE, exercise.setup="expgrowthsetup01"}
...
```{r expgrowthex, exercise = TRUE, exercise.setup = "expgrowth01"}
