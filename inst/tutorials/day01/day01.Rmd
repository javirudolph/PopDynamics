...
You can also experiment using different starting values, by changing the number **2** in the previous code to a different one.

```{r, expgrowth02, exercise=TRUE, exercise.setup = "expgrowth01"}
...
```{r expgrowthex, exercise = TRUE, exercise.setup = "expgrowth02"}
