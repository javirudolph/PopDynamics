...
# Then, we build the sequence of time. Notice we use a colon to denote a sequence of numbers from 1 to 100
t <- 1:tmax
...
# You can type each of the previously assigned objects to see how they look like, and press the keyboard shortcut to run each line
# For example:
