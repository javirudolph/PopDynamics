...
You can also press the *Start Over* button and try different operations. You can also run multiple operations in the same window, as long as each operation is on one line. 
